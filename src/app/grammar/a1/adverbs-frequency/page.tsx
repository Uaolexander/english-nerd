...
export default function Page() {
  return (
    <>
      <LessonSchema
        title="Adverbs of Frequency (Always, Usually, Often, Sometimes, Never) Exercises with Answers (A1)"
        description="Learn English adverbs of frequency: always, usually, often, sometimes, rarely, never. A1 grammar lesson with word order rules and 4 exercises."
        url="https://englishnerd.cc/grammar/a1/adverbs-frequency"
        level="A1"
      />
