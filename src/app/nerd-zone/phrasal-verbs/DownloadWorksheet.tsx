  ...
  return (
    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", backgroundColor: "#F5DA20", padding: "14px 32px" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        {/* EN logo — lineHeight = height is the only reliable centering in html2canvas */}
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        <span style={{ ...C, display: "inline-block", height: 24, lineHeight: "24px", paddingLeft: 12, paddingRight: 12, fontSize: 10, fontWeight: 900, backgroundColor: "#000", color: "#F5DA20", borderRadius: 20, textTransform: "uppercase", letterSpacing: "0.08em" }}>A1 Level</span>
          ...
          <ol style={{ listStyle: "none", margin: 0, padding: 0, flex: 1 }}>
            {EXERCISES.map(({ before, after }, i) => (
              <li key={i} style={{ display: "flex", gap: 10, marginBottom: 14, alignItems: "flex-start" }}>
                <span style={{ ...C, flexShrink: 0, display: "inline-block", width: 22, height: 22, lineHeight: "22px", textAlign: "center", borderRadius: "50%", backgroundColor: "rgba(0,0,0,0.07)", fontSize: 11, fontWeight: 900, color: "#475569", marginTop: 1 }}>
                  {i + 1}
                </span>
