...
const LEVELS: Level[] = [
  {
    lvl: "A1",
    label: "Beginner",
    description: "Everyday essentials: numbers, colours, family, food, body parts, common verbs.",
    topics: 20,
    color: "bg-[#F5DA20]",
  ...
  },
  {
    lvl: "A2",
    label: "Elementary",
    description: "Shopping, travel, routines, feelings, directions and common phrases.",
    topics: 20,
  ...
  },
  {
    ...
    description: "Academic words, phrasal verbs, collocations and formal register.",
    topics: 20,
    color: "bg-orange-400",
    textColor: "text-black",
  },
