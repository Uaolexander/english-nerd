...
export const metadata: Metadata = {
  title: "B2 Reading Practice — English Nerd",
  description:
    "B2 upper-intermediate English reading exercises. Editorials, opinion pieces and reports with true/false, comprehension and fill-in-the-blanks tasks.",
  alternates: { canonical: "/reading/b2" },
};
...
const EXERCISES: Exercise[] = [
  {
    ...
    description:
      "Read what four urban planners say about the future of cities. Are the statements true or false?",
    questions: 8,
    tag: "True / False",
    image: "/topics/reading/b2/changing-cities.jpg",
    isNew: true,
  },
  {
    ...
    description:
      "Read the article about how habits form and are broken, then answer the comprehension questions.",
    questions: 6,
    tag: "Comprehension",
    image: "/topics/reading/b2/the-psychology-of-habits.jpg",
    isNew: true,
  },
  {
    ...
    description:
      "Read the opinion piece about gig economy workers and fill in the missing words.",
    questions: 8,
    tag: "Fill in Blanks",
    image: "/topics/reading/b2/the-gig-economy.jpg",
    isNew: true,
  },
];

export default function ReadingB2Page() {
  return (
      ...
      <div className="relative z-10">
        <div className="mx-auto max-w-6xl px-6 py-10">
          ...
          <h1 className="mt-4 text-3xl md:text-5xl font-black tracking-tight">
            B2 Reading <span className="text-[#F5DA20]">Exercises</span>
          </h1>
          <p className="mt-3 max-w-2xl text-white/55 text-base leading-relaxed">
            Upper-intermediate level. Editorials, opinion pieces and analytical texts with
            comprehension, true/false and gap-fill tasks to sharpen your reading accuracy.
          </p>
          ...
          <div className="mt-8 flex items-start gap-4 overflow-hidden rounded-2xl border border-[#F5DA20]/20 bg-[#F5DA20]/6 px-5 py-4">
            ...
            <div>
              <p className="font-bold text-white text-sm">B2 reading strategy</p>
              <p className="mt-0.5 text-sm text-white/45">
                At B2, texts are longer and more complex. Skim for the main idea first, then
                read carefully for detail. Pay attention to the writer&apos;s attitude and
                how evidence is used to support an argument.
              </p>
            </div>
          </div>
                ...
                {EXERCISES.map((ex) => (
                  ...
                  >
                    ...
                    <div className="relative aspect-[4/3] w-full overflow-hidden border-b border-white/10 bg-black/30">
                      ...
                      {/* B2 badge */}
                      <div className="absolute top-3 left-3 rounded-full bg-orange-400 px-3 py-1 text-xs font-black text-black shadow-lg">
                        B2
                      </div>
