      ...
      <div className="mx-auto max-w-6xl px-6 py-12">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex flex-col items-end gap-1">
            <DownloadWorksheet isLoggedIn={isLoggedIn} level="B2" title="English Slang" wordBank={WORD_BANK} exercises={EXERCISES} loginRedirect="/nerd-zone/slang/b2" filename="Slang_B2_Worksheet_EnglishNerd.pdf" />
