...
export default function Page() {
  return (
    <>
      <LessonSchema
        title="There is / There are Exercises with Answers for Beginners (A1)"
        description="Learn to use there is and there are in English. A1 grammar lesson covering affirmative, negative and questions with 4 interactive exercises."
        url="https://englishnerd.cc/grammar/a1/there-is-there-are"
        level="A1"
      />
