...
export const metadata = {
  title: "Past Continuous Exercises — Practice English Grammar | English Nerd",
  description:
    "Practise the Past Continuous tense with multiple choice, fill-in-the-blank, spot-the-mistake, and sentence-builder exercises. Learn was/were + -ing, interrupted actions with when and while, and the difference between Past Simple and Past Continuous.",
  keywords: [
    "past continuous exercises",
    "past continuous practice",
    "was were ing exercises",
    "while when past tense",
    "past simple vs past continuous",
    "english grammar A2 B1",
  ],
};
...
const EXERCISES: Exercise[] = [
  {
    ...
    label: "Quiz",
    description: "Choose the correct Past Continuous form from four options.",
    difficulty: "Easy",
  ...
  },
  {
    ...
    label: "Writing",
    description: "Type the correct was/were + -ing form to complete the sentence.",
    difficulty: "Medium",
  ...
  },
  {
    ...
    label: "Sharp eye",
    description: "Find the grammar error: wrong auxiliary, missing -ing, or wrong tense.",
    difficulty: "Medium",
    difficultyColor: "bg-[#F5DA20]",
  },
  {
    slug: "sentence-builder",
    imageSlug: "sentence-builder-past-continuous",
    title: "Sentence Builder",
    label: "Order",
    description: "Rearrange the words to build a correct Past Continuous sentence.",
    difficulty: "Medium",
    difficultyColor: "bg-[#F5DA20]",
  },
];
...
const RELATED: Exercise[] = [
  {
    ...
    title: "was / were + -ing",
    label: "Structure",
    description: "Form the Past Continuous correctly with was/were and the -ing verb.",
    difficulty: "Easy",
    difficultyColor: "bg-emerald-400",
  },
  {
    ...
    title: "when vs while",
    label: "Connectors",
    description: "She was cooking when he arrived. While I was reading, it started to rain.",
    difficulty: "Medium",
    difficultyColor: "bg-[#F5DA20]",
  },
  {
    ...
    label: "Comparison",
    description: "Completed actions vs actions in progress — choose the right tense.",
    difficulty: "Medium",
    difficultyColor: "bg-[#F5DA20]",
  },
  {
    slug: "interrupted-actions",
    title: "Interrupted Actions",
    label: "Advanced",
    description: "I was walking home when it started to rain. The full pattern.",
    difficulty: "Hard",
  ...
  return (
    <main className="relative min-h-screen bg-[#0E0F13] text-white">
      <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-32 left-1/2 h-[500px] w-[700px] -translate-x-1/2 rounded-full bg-emerald-500/5 blur-[150px]" />
        <div className="absolute top-1/3 -left-32 h-[400px] w-[400px] rounded-full bg-violet-400/4 blur-[120px]" />
        <div className="absolute top-1/3 -right-32 h-[400px] w-[400px] rounded-full bg-emerald-400/4 blur-[120px]" />
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 py-12">
        <div className="text-sm text-white/40">
          ...
          <span className="mx-2 text-white/20">/</span>
          <span className="text-white/70">Past Continuous</span>
        </div>

        <div className="mt-6">
          <div className="flex items-center gap-3">
            <span className="rounded-full bg-emerald-400 px-3 py-0.5 text-[11px] font-black text-black">A2–B1</span>
            <span className="text-xs font-bold uppercase tracking-widest text-white/25">Past</span>
          </div>
          <h1 className="mt-3 text-4xl font-black tracking-tight md:text-6xl">
            Past{" "}
            <span className="relative inline-block">
              <span className="relative z-10 text-emerald-400">Continuous</span>
          ...
          <p className="mt-4 max-w-xl text-white/45 text-base leading-relaxed">
            Actions in progress at a specific moment in the past. Choose an exercise and start practising.
          </p>
        </div>

        <div className="mt-6 flex flex-wrap gap-2">
          {[
            { label: "+", example: "She was working at 8pm." },
            { label: "−", example: "He wasn't sleeping." },
            { label: "?", example: "Were they working?" },
          ].map(({ label, example }) => (
        ...
        <div className="mt-14 flex flex-col gap-14">
          <CardGroup label="Exercises" sublabel="Practice Past Continuous with different task types" dotColor="bg-emerald-400" exercises={EXERCISES} basePath="/tenses/past-continuous" />
          ...
          <CardGroup label="Related Topics" sublabel="was/were + -ing, when/while, interrupted actions, and comparison with Past Simple" dotColor="bg-[#F5DA20]" exercises={RELATED} basePath="/tenses/past-continuous" />
        </div>
      </div>
    </main>
  );
