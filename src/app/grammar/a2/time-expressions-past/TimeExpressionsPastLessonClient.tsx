...
const RECOMMENDATIONS: GrammarRec[] = [
  { title: "Past Simple (Regular)", href: "/grammar/a2/past-simple-regular", level: "A2", badge: "bg-emerald-600", reason: "Time expressions go hand in hand with past simple" },
  { title: "Past Simple (Irregular)", href: "/grammar/a2/past-simple-irregular", level: "A2", badge: "bg-emerald-600", reason: "Use time expressions with irregular verbs too" },
  { title: "Past Simple: Negatives & Questions", href: "/grammar/a2/past-simple-negative-questions", level: "A2", badge: "bg-emerald-600" },
];
