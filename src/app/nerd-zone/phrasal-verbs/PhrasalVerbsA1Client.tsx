...
const PDF_CONFIG: LessonPDFConfig = {
  ...
  level: "A1",
  keyRule: "wake up · get up · turn on · turn off · put on · take off · look for · come in · go out · pick up · sit down · stand up",
  exercises: [
    {
      number: 1,
      title: "Exercise 1",
      ...
      questions: [
        "I usually ___ at 7 o'clock every morning. (wake up / sit down)",
        "Can you ___ the lights? It's dark in here. (turn on / turn off)",
        "Don't forget to ___ your coat — it's cold outside! (put on / take off)",
        "Everyone stood up and then ___ when the teacher said so. (sit down / come in)",
        "I've lost my phone. I'm ___ it everywhere. (looking for / picking up)",
        "Please ___ your shoes before entering the house. (take off / put on)",
        "The box fell. Can you ___ it for me? (pick up / stand up)",
        "They love to ___ and try new restaurants at weekends. (go out / wake up)",
        "___ ! The door is open and we're waiting for you. (Come in / Go out)",
        "He forgot to ___ the lights before leaving the room. (turn off / turn on)",
      ],
    },
    {
      number: 2,
      title: "Exercise 2",
      difficulty: "Medium",
      instruction: "Type the correct phrasal verb to complete the sentence.",
      questions: [
        "My alarm rang at 6:30, but I didn't ___ until 7.",
        "Can you ___ the television? The match is starting.",
        "Please ___ the lights when you leave the room.",
        "She ___ her jacket as soon as she got home.",
        "I can't find my keys — I've been ___ them all morning.",
        "___ ! We've been waiting for you.",
        "Could you ___ that pen for me? I dropped it.",
        "They decided to ___ and explore the city.",
        "He ___ early, had breakfast and went to work.",
        "Everyone ___ when the music started.",
      ],
    },
    {
      number: 3,
      ...
      questions: [
        "She woke up early. → wake up = (a) stopped sleeping (b) started sleeping",
        "Turn off the TV. → turn off = (a) start a device (b) stop a device",
        "He put on his coat. → put on = (a) removed (b) dressed in",
        "I'm looking for my glasses. → look for = (a) wearing (b) trying to find",
        "Come in, the door is open! → come in = (a) leave (b) enter a place",
        "She picked up the bag. → pick up = (a) dropped (b) lifted",
        "They go out every Friday. → go out = (a) stay home (b) leave and socialise",
        "Please sit down! → sit down = (a) stand up (b) take a seat",
        "She took off her shoes. → take off = (a) put on (b) remove",
        "He got up at 8. → get up = (a) went to sleep (b) rose from bed",
      ],
    },
    {
      number: 4,
      title: "Exercise 4",
      difficulty: "Hard",
      instruction: "Complete each sentence with a phrasal verb in the correct form.",
      questions: [
        "It's raining! Don't forget to ___ your coat.",
        "She ___ her shoes and put them by the door.",
        "I'm going to ___ and meet some friends tonight.",
        "Can you ___ the laptop? We need to start the meeting.",
        "He ___ at 6, made coffee, and went for a run.",
        "I've been ___ my passport for an hour!",
        "The baby is asleep — please ___ the music.",
        "Don't just stand there — ___!",
        "Someone knocks. You say: '___ ! The door is open.'",
        "Could you ___ my bag from the floor? My back hurts.",
      ],
    },
  ],
  answerKey: [
    { exercise: 1, subtitle: "Easy — choose the phrasal verb", answers: ["wake up","turn on","put on","sat down","looking for","take off","pick up","go out","Come in","turn off"] },
    { exercise: 2, subtitle: "Medium — type the phrasal verb", answers: ["wake up","turn on","turn off","took off","looking for","Come in","pick up","go out","got up","stood up"] },
    { exercise: 3, subtitle: "Medium — choose the meaning", answers: ["(a) stopped sleeping","(b) stop a device","(b) dressed in","(b) trying to find","(b) enter a place","(b) lifted","(b) leave and socialise","(b) take a seat","(b) remove","(b) rose from bed"] },
