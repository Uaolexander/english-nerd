...
export const metadata: Metadata = {
  title: "A1 Vocabulary Exercises — English Nerd",
  description:
    "A1 Beginner vocabulary exercises. Read simple dialogues and choose the correct word from context. Perfect for absolute beginners.",
  alternates: { canonical: "/vocabulary/a1" },
};
...
const EXERCISES: Exercise[] = [
  {
    ...
    title: "At the Café",
    description:
      "Maria and Pedro go to a café for breakfast. Read the dialogue and choose the correct word in each gap.",
    questions: 10,
    tag: "Dialogue",
    image: "/topics/vocabulary/a1/at-the-cafe.jpg",
    isNew: true,
  },
  {
    slug: "animals",
    title: "Animals",
    description:
      "Learn animal vocabulary with three activities: multiple choice, choose the word, and fill in the blanks.",
    questions: 10,
    tag: "3 Exercises",
    image: "/topics/vocabulary/a1/animals.jpg",
    isNew: true,
  },
  {
    slug: "my-family",
    title: "My Family",
    description:
      "Anna tells her friend Tom about her family. Read the dialogue and choose the correct word for each gap.",
    questions: 10,
    tag: "Dialogue",
    image: "/topics/vocabulary/a1/my-family.jpg",
    isNew: true,
  },
  {
    slug: "my-body",
    title: "My Body",
    description:
      "Learn body part vocabulary with three activities: multiple choice, choose the word, and fill in the blanks.",
    questions: 10,
    tag: "3 Exercises",
    image: "/topics/vocabulary/a1/my-body.jpg",
    isNew: true,
  },
];

export default async function VocabularyA1Page() {
      ...
      <div className="relative z-10">
        <div className="mx-auto max-w-6xl px-6 py-10">
          ...
          <h1 className="mt-4 text-3xl md:text-5xl font-black tracking-tight">
            A1 Vocabulary <span className="text-[#F5DA20]">Exercises</span>
          </h1>
          <p className="mt-3 max-w-2xl text-white/55 text-base leading-relaxed">
            Beginner level — read short dialogues and texts, then choose the correct word from context.
            Great for building everyday vocabulary from scratch.
          </p>
          ...
          <div className="mt-8 flex items-start gap-4 overflow-hidden rounded-2xl border border-[#F5DA20]/20 bg-[#F5DA20]/6 px-5 py-4">
            ...
            <div>
              ...
              <p className="mt-0.5 text-sm text-white/45">
                Read the full dialogue first to understand the situation. Then go through each gap and choose the word that fits best. Check your answers at the end.
              </p>
            </div>
          </div>
                    ...
                    >
                      ...
                      <div className="relative aspect-video w-full overflow-hidden bg-black/40">
                        ...
                        <div className="absolute left-3 top-3 flex items-center gap-2">
                          <span className="rounded-full bg-[#F5DA20] px-2.5 py-0.5 text-[10px] font-black text-black">A1</span>
                      ...
                      {/* Full card link */}
                      {!ex.comingSoon && (
                        <a href={`/vocabulary/a1/${ex.slug}`} className="absolute inset-0" aria-label={ex.title} />
                      )}
                    </article>
                  ))}
                </div>
