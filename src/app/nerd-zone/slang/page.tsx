      ...
      <div className="mx-auto max-w-6xl px-6 py-12">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex flex-col items-end gap-1">
            <DownloadWorksheet isPro={isPro} level="A1-A2" title="English Slang" wordBank={WORD_BANK} exercises={EXERCISES} filename="Slang_A1A2_Worksheet_EnglishNerd.pdf" />
        ...
        <div className="mt-4 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
          ...
          <div>
            {WORDS.flatMap(({ word, meaning, example }, i) => {
              const row = (
          ...
          <div className="border-t border-slate-100 bg-slate-50 px-5 py-3"><span className="text-xs text-slate-400">24 words · A1-A2 · everyday informal English</span></div>
        </div>
