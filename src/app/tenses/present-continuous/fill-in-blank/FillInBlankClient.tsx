      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
          ...
          {isPro ? (
            <aside className="flex flex-col gap-3">
              ...
              {[
                ...
                { title: "Spot the Mistake", href: "/tenses/present-continuous/spot-the-mistake", img: "/topics/exercises/spot-the-mistake.jpg", level: "A2", badge: "bg-amber-500", reason: "Find & fix errors" },
                { title: "-ing Spelling Rules", href: "/tenses/present-continuous/ing-forms", img: "/topics/exercises/ing-forms.jpg", level: "A2", badge: "bg-sky-500", reason: "Master -ing spelling rules" },
              ].map((rec) => (
        ...
        {!isPro && (
          <div className="mt-10 grid gap-8 lg:grid-cols-[300px_1fr_300px]">
            ...
            <SpeedRound gameId="pc-fill-in-blank" subject="Present Continuous Writing" questions={PC_SPEED_QUESTIONS} />
            <div className="hidden lg:block" />
          </div>
        )}
