...
export default async function GrammarB2Page() {
      ...
      <div className="relative z-10">
        <div className="mx-auto max-w-6xl px-6 py-10">
          ...
          <h1 className="mt-4 text-3xl md:text-5xl font-black tracking-tight">
            B2 Grammar Lessons <span className="text-[#F5DA20]">&</span> Exercises
          </h1>
                      ...
                      <div className="p-5">
                        ...
                        <div className="mt-4 flex items-center justify-between">
                          <a
                            ...
                            aria-label={t.title}
                          />
                          <a href={`/grammar/b2/${t.slug}`} className="relative z-20 inline-flex items-center justify-center rounded-xl bg-[#F5DA20] px-4 py-2 text-sm font-bold text-black hover:opacity-90">
                              Start
                            </a>
