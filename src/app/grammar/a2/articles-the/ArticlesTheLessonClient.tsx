...
const RECOMMENDATIONS: GrammarRec[] = [
  { title: "Object Pronouns", href: "/grammar/a2/object-pronouns", level: "A2", badge: "bg-emerald-600", reason: "Use 'the' and pronouns together naturally" },
  { title: "Possessive Pronouns", href: "/grammar/a2/possessive-pronouns", level: "A2", badge: "bg-emerald-600", reason: "Mine, yours, theirs — related to noun reference" },
    ...
    <div className="mx-auto max-w-7xl px-6 py-10">
      ...
      {!isPro && (
        <div className="mt-10 grid gap-8 lg:grid-cols-[300px_1fr_300px]">
          ...
          <SpeedRound gameId="grammar-a2-articles-the" subject="Articles: a / an / the" questions={SPEED_QUESTIONS} />
          <div className="hidden lg:block" />
        </div>
      )}
