...
export default function VocabCertificateModal({ band, estimatedVocabulary, onClose, onSaved }: Props) {
  ...
  const scorePercent = Math.round((estimatedVocabulary / 9000) * 100);
  ...
  async function downloadPDF() {
    ...
    try {
      ...
      pdf.save(`EnglishNerd_Vocabulary_${name.replace(/\s+/g, "_")}.pdf`);
      ...
      try {
        const res = await fetch("/api/certificates/save", {
          ...
          body: JSON.stringify({
            level: band,
            scorePercent,
            scoreCorrect: estimatedVocabulary,
            scoreTotal: 9000,
    ...
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="w-full max-w-3xl rounded-2xl border border-black/10 bg-white shadow-2xl overflow-hidden">
        ...
        <div className="flex items-center justify-between border-b border-black/8 px-6 py-4">
          <div>
            <h2 className="text-lg font-black text-[#0F0F12]">Download Vocabulary Certificate</h2>
        ...
        <div className="px-6 py-5 bg-slate-50">
          ...
          {/* Certificate div — rendered to PDF */}
          <div
            ref={certRef}
            style={{
              width: "794px",
          ...
          >
            ...
            <div style={{
              ...
              <p style={{
                ...
                has demonstrated an estimated active vocabulary of
              </p>
              ...
              <div style={{
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
                    ...
                    <span style={{ fontSize: "10px", color: "rgba(0,0,0,0.4)", textTransform: "uppercase", letterSpacing: "1px", marginTop: "4px" }}>
                      level
                    </span>
                  </div>
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
                    <span style={{ fontSize: "14px", fontWeight: "700", color: "#0F0F12", fontFamily: "Georgia, serif" }}>
                      {BAND_LABEL[band]}
                    </span>
