...
const TEXT_PARTS = [
  "Working from home has become very common in recent years. Many people enjoy the freedom to set their own ", // before gap 1
  " and work at times that suit them. Without the need to ", // before gap 2
  " to an office, workers save time and money. Many also report feeling more ", // before gap 3
  " because they can focus without office noise. However, remote work is not without its challenges. Some people find it hard to stay focused and feel ", // before gap 4
  " by household tasks and family. Others struggle with ", // before gap 5
  ", missing the social side of office life and daily contact with ", // before gap 6
  ". Experts recommend setting clear ", // before gap 7
  " between work and personal time, for example by finishing work at the same time every day. Having a dedicated workspace also helps. Overall, remote work suits some people very well, but others prefer the structure and social environment of an office.", // after gap 8 (appended after gap 8)
];
      ...
      <div className="bg-[#0E0F13] text-white">
        <div className="mx-auto max-w-3xl px-6 py-8">
          ...
          <div className="text-sm text-white/50">
            ...
            <span className="text-white/25">/</span>{" "}
            <span className="text-white/80">Work From Home</span>
          </div>
          ...
          <h1 className="mt-3 text-2xl font-black md:text-3xl">Work From Home</h1>
          <p className="mt-1 text-sm text-white/50">
            Click a gap in the text, then click a word from the box to fill it in.
          </p>
        </div>
      </div>
