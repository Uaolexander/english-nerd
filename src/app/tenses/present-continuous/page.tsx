...
export const metadata = {
  alternates: { canonical: "/tenses/present-continuous" },
  title: { absolute: "Present Continuous Exercises — Practice English Grammar | English Nerd" },
  description:
    "Practise the Present Continuous tense with multiple choice, fill-in-the-blank, spot-the-mistake, and sentence-builder exercises. Learn -ing forms, stative verbs, and the difference between Present Simple and Present Continuous.",
  keywords: [
...
const EXERCISES: Exercise[] = [
  {
    ...
    label: "Quiz",
    description: "Choose the correct Present Continuous form from four options.",
    difficulty: "Easy",
  ...
  },
  {
    ...
    label: "Writing",
    description: "Type the correct -ing form of the verb to complete the sentence.",
    difficulty: "Medium",
  ...
  },
  {
    ...
    imageSlug: "sentence-builder-present-continuous",
    title: "Sentence Builder",
    label: "Order",
    description: "Rearrange the words to build a correct Present Continuous sentence.",
    difficulty: "Medium",
    difficultyColor: "bg-[#F5DA20]",
  },
];
...
const RELATED: Exercise[] = [
  {
    ...
    label: "Spelling",
    description: "stop→stopping, run→running, make→making. Master the rules.",
    difficulty: "Easy",
    difficultyColor: "bg-emerald-400",
  },
  {
    ...
    title: "Stative Verbs",
    label: "No -ing",
    description: "Verbs that are never used in continuous: know, want, have…",
    difficulty: "Medium",
    difficultyColor: "bg-[#F5DA20]",
  },
  {
    ...
    label: "Comparison",
    description: "Habits and routines vs actions happening right now.",
    difficulty: "Medium",
    difficultyColor: "bg-[#F5DA20]",
  },
  {
    ...
    title: "Advanced Mix",
    label: "Advanced",
    description: "State verbs, time expressions, and tricky boundary cases.",
    difficulty: "Hard",
    ...
    <main className="relative min-h-screen bg-[#0E0F13] text-white">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 py-12">
        ...
        <div className="text-sm text-white/40">
          ...
          <span className="mx-2 text-white/20">/</span>
          <span className="text-white/70">Present Continuous</span>
        </div>
        ...
        <div className="mt-6">
          ...
          <h1 className="mt-3 text-4xl font-black tracking-tight md:text-6xl">
            ...
            <span className="relative inline-block">
              <span className="relative z-10 text-[#F5DA20]">Continuous</span>
          ...
          <p className="mt-4 max-w-xl text-white/45 text-base leading-relaxed">
            Actions happening right now or around this time. Choose an exercise and start practising.
          </p>
        </div>

        <div className="mt-6 flex flex-wrap gap-2">
          {[
            { label: "+", example: "She is working now." },
            { label: "−", example: "He isn't working today." },
            { label: "?", example: "Are they working?" },
          ].map(({ label, example }) => (
        ...
        <div className="mt-14 flex flex-col gap-14">
          <CardGroup
            label="Exercises"
            sublabel="Practice Present Continuous with different task types"
            dotColor="bg-[#F5DA20]"
            exercises={EXERCISES}
            basePath="/tenses/present-continuous"
          />
          <AdUnit variant="inline-light" />
          <RelatedTopics exercises={RELATED} basePath="/tenses/present-continuous" />
        </div>
