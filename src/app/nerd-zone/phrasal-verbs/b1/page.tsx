      ...
      <div className="mx-auto max-w-6xl px-6 py-12">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex flex-col items-end gap-1">
            <DownloadWorksheet isLoggedIn={isLoggedIn} level="B1" wordBank={WORD_BANK} exercises={EXERCISES} loginRedirect="/nerd-zone/phrasal-verbs/b1" filename="PhrasalVerbs_B1_Worksheet_EnglishNerd.pdf" />
