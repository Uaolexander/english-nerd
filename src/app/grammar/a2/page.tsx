...
export default function GrammarA2Page() {
  return (
    <main className="relative min-h-screen bg-[#0E0F13] text-white">
      {/* Background glow */}
      <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 left-1/2 h-[520px] w-[520px] -translate-x-1/2 rounded-full bg-emerald-400/20 blur-[140px]" />
        <div className="absolute top-1/3 -left-40 h-[400px] w-[400px] rounded-full bg-emerald-400/10 blur-[160px]" />
      ...
      <div className="relative z-10">
        <div className="mx-auto max-w-6xl px-6 py-10">
          ...
          <h1 className="mt-4 text-3xl md:text-5xl font-black tracking-tight">
            A2 Grammar Lessons <span className="text-emerald-400">&</span> Exercises
          </h1>
                  ...
                  >
                    ...
                    <div className="p-5">
                      ...
                      <div className="mt-4 flex items-center justify-between">
                        ...
                        />
                        <button
                          className="relative z-20 inline-flex items-center justify-center rounded-xl bg-emerald-400 px-4 py-2 text-sm font-bold text-black hover:opacity-90"
                          type="button"
                        >
                          Start
                        </button>
