...
export const metadata = {
  alternates: { canonical: "/tenses/present-perfect" },
  title: { absolute: "Present Perfect Exercises — Practice English Grammar | English Nerd" },
  description:
    "Practise the Present Perfect tense with multiple choice, fill-in-the-blank, spot-the-mistake, and sentence-builder exercises. Learn have/has, irregular past participles, for vs since, and how Present Perfect differs from Past Simple.",
  keywords: [
    "present perfect exercises",
    "present perfect practice",
    "have has grammar exercises",
...
const EXERCISES: Exercise[] = [
  {
    ...
    label: "Quiz",
    description: "Choose the correct Present Perfect form from four options.",
    difficulty: "Easy",
  ...
  },
  {
    ...
    label: "Writing",
    description: "Type the correct have/has + past participle form.",
    difficulty: "Medium",
  ...
  },
  {
    ...
    label: "Sharp eye",
    description: "Find the grammar error: wrong participle, wrong auxiliary, or wrong tense.",
    difficulty: "Medium",
    difficultyColor: "bg-[#F5DA20]",
  },
  {
    slug: "sentence-builder",
    imageSlug: "sentence-builder-present-perfect",
    title: "Sentence Builder",
    label: "Order",
    description: "Rearrange the words to form a correct Present Perfect sentence.",
    difficulty: "Medium",
    difficultyColor: "bg-[#F5DA20]",
  },
];
...
const RELATED: Exercise[] = [
  {
    slug: "have-has",
    title: "have / haven't / Have I?",
    label: "Auxiliary",
    description: "Master the auxiliary verb 'have' — positives, negatives, and questions.",
    difficulty: "Easy",
    difficultyColor: "bg-emerald-400",
  },
  {
    ...
    label: "Vocabulary",
    description: "gone, been, seen, done, written — the 50 most common irregular forms.",
    difficulty: "Medium",
    difficultyColor: "bg-[#F5DA20]",
  },
  {
    ...
    title: "for vs since",
    label: "Time",
    description: "for three years vs since 2020. Know when to use each.",
    difficulty: "Medium",
    difficultyColor: "bg-[#F5DA20]",
  },
  {
    ...
    label: "Comparison",
    description: "The most common confusion in English — when to use which tense.",
    difficulty: "Hard",
  ...
  return (
    <main className="relative min-h-screen bg-[#0E0F13] text-white">
      <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/3 -right-32 h-[400px] w-[400px] rounded-full bg-[#F5DA20]/4 blur-[120px]" />
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 py-12">
        ...
        <div className="text-sm text-white/40">
          ...
          <span className="mx-2 text-white/20">/</span>
          <span className="text-white/70">Present Perfect</span>
        </div>
        ...
        <div className="mt-6">
          ...
          <p className="mt-4 max-w-xl text-white/45 text-base leading-relaxed">
            Past actions with a connection to the present. Choose an exercise and start practising.
          </p>
        </div>

        <div className="mt-6 flex flex-wrap gap-2">
          {[
            { label: "+", example: "She has worked here for years." },
            { label: "−", example: "He hasn't called yet." },
            { label: "?", example: "Have they finished?" },
          ].map(({ label, example }) => (
        ...
        <div className="mt-14 flex flex-col gap-14">
          <CardGroup
            label="Exercises"
            sublabel="Practice Present Perfect with different task types"
