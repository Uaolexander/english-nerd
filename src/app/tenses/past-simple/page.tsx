...
export const metadata = {
  alternates: { canonical: "/tenses/past-simple" },
  title: { absolute: "Past Simple Exercises — Practice English Grammar | English Nerd" },
  description:
    "Practise the Past Simple tense with multiple choice, fill-in-the-blank, spot-the-mistake, and sentence-builder exercises. Learn regular and irregular past forms, negatives with didn't, and questions with Did.",
  keywords: [
    "past simple exercises",
    "past simple practice",
    "irregular verbs past simple",
    "did didn't grammar exercises",
    "english grammar A2",
...
const EXERCISES: Exercise[] = [
  {
    ...
    label: "Quiz",
    description: "Choose the correct Past Simple form from four options.",
    difficulty: "Easy",
  ...
  },
  {
    ...
    label: "Writing",
    description: "Type the correct past form of the verb to complete the sentence.",
    difficulty: "Medium",
  ...
  },
  {
    ...
    imageSlug: "sentence-builder-past-simple",
    title: "Sentence Builder",
    label: "Order",
    description: "Rearrange the words to build a correct Past Simple sentence.",
    difficulty: "Medium",
    difficultyColor: "bg-[#F5DA20]",
  },
];
...
const RELATED: Exercise[] = [
  {
    slug: "regular-past-simple",
    title: "Regular Verbs: -ed",
    label: "Spelling",
    description: "walk→walked, stop→stopped, study→studied. Spelling rules for -ed.",
    difficulty: "Easy",
    difficultyColor: "bg-emerald-400",
  },
  {
    slug: "irregular-past-simple",
    title: "Irregular Verbs",
    label: "Vocabulary",
    description: "go→went, see→saw, have→had. The 60 most essential irregular forms.",
    difficulty: "Medium",
    difficultyColor: "bg-[#F5DA20]",
  },
  {
    slug: "did-didnt",
    title: "did / didn't / Did I?",
    label: "Auxiliary",
    description: "Master the auxiliary verb 'did' — negatives and questions.",
    difficulty: "Medium",
    difficultyColor: "bg-[#F5DA20]",
  },
  {
    ...
    label: "Comparison",
    description: "Completed actions vs actions in progress at a past moment.",
    difficulty: "Hard",
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 py-12">
        ...
        <div className="mt-6">
          ...
          <p className="mt-4 max-w-xl text-white/45 text-base leading-relaxed">
            Completed actions at a specific time in the past. Choose an exercise and start practising.
          </p>
        </div>

        <div className="mt-6 flex flex-wrap gap-2">
          {[
            { label: "+", example: "She worked yesterday." },
            { label: "−", example: "He didn't work last week." },
            { label: "?", example: "Did they work?" },
          ].map(({ label, example }) => (
