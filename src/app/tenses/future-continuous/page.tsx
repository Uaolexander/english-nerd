...
export const metadata = {
  ...
  keywords: [
    ...
    "will be ing exercises",
    "future progressive grammar",
    "this time tomorrow english",
    "english grammar B2",
  ],
};
...
const EXERCISES: Exercise[] = [
  {
    ...
    label: "Quiz",
    description: "Choose the correct Future Continuous form from four options.",
    difficulty: "Medium",
  ...
  },
  {
    ...
    label: "Writing",
    description: "Type the correct will be + -ing form to complete the sentence.",
    difficulty: "Medium",
    difficultyColor: "bg-[#F5DA20]",
  },
  {
    ...
    label: "Sharp eye",
    description: "Find the error: missing 'be', wrong -ing form, or wrong tense.",
    difficulty: "Hard",
    difficultyColor: "bg-rose-400",
  },
  {
    slug: "sentence-builder",
    imageSlug: "sentence-builder-future-continuous",
    title: "Sentence Builder",
    label: "Order",
    description: "Rearrange the words to build a correct Future Continuous sentence.",
    difficulty: "Hard",
    difficultyColor: "bg-rose-400",
  },
];
...
const RELATED: Exercise[] = [
  {
    ...
    title: "will be + -ing",
    label: "Structure",
    description: "Form the Future Continuous correctly: will + be + verb-ing.",
    difficulty: "Medium",
    difficultyColor: "bg-[#F5DA20]",
  },
  {
    slug: "at-future-moment",
    title: "At a Future Moment",
    label: "Use",
    description: "This time tomorrow, I'll be flying to London. Actions in progress at a set future time.",
    difficulty: "Medium",
    difficultyColor: "bg-[#F5DA20]",
  },
  {
    slug: "polite-questions",
    title: "Polite Questions",
    label: "Use",
    description: "Will you be using the car tonight? A softer way to ask about plans.",
    difficulty: "Medium",
    difficultyColor: "bg-[#F5DA20]",
  },
  {
    slug: "will-vs-will-be-ing",
    title: "will vs will be doing",
    label: "Comparison",
    description: "I will call vs I will be calling. When to use each form.",
    difficulty: "Hard",
    difficultyColor: "bg-rose-400",
  },
];
    ...
    <main className="relative min-h-screen bg-[#0E0F13] text-white">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 py-12">
        <div className="text-sm text-white/40">
          ...
          <span className="text-white/70">Future Continuous</span>
        </div>
        <div className="mt-6">
          ...
          <p className="mt-4 max-w-xl text-white/45 text-base leading-relaxed">Actions that will be in progress at a specific future moment. Choose an exercise and start practising.</p>
        </div>
        <div className="mt-6 flex flex-wrap gap-2">
          {[{ label: "+", example: "She will be working at 8pm." }, { label: "−", example: "He won't be sleeping." }, { label: "?", example: "Will they be working?" }].map(({ label, example }) => (
        ...
        <div className="mt-14 flex flex-col gap-14">
          <CardGroup label="Exercises" sublabel="Practice Future Continuous with different task types" dotColor="bg-orange-400" exercises={EXERCISES} basePath="/tenses/future-continuous" />
          ...
          <CardGroup label="Related Topics" sublabel="will be + -ing structure, future moments, polite questions, and comparison with will" dotColor="bg-[#F5DA20]" exercises={RELATED} basePath="/tenses/future-continuous" />
        </div>
      </div>
    </main>
  );
