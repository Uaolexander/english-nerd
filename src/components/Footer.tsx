      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-8 flex items-center justify-between gap-4 rounded-2xl border border-white/8 bg-white/4 px-5 py-3.5">
          <div className="flex items-center gap-2.5">
            ...
            <p className="text-xs text-white/55">No ads · Progress dashboard · Certificates · Priority access</p>
          </div>
          <a
            href="/pro"
        ...
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-5">
          ...
          <div className="flex flex-col gap-2">
            <span className="text-[11px] font-bold uppercase tracking-widest text-white/45">Grammar</span>
          ...
          {/* Tenses */}
          <div className="flex flex-col gap-2">
            <span className="text-[11px] font-bold uppercase tracking-widest text-white/45">Tenses</span>
          ...
          {/* Tests */}
          <div className="flex flex-col gap-2">
            <span className="text-[11px] font-bold uppercase tracking-widest text-white/45">Tests</span>
          ...
          {/* Learn */}
          <div className="flex flex-col gap-2">
            <span className="text-[11px] font-bold uppercase tracking-widest text-white/45">Learn</span>
        ...
        <div className="mt-8 border-t border-white/6 pt-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <span className="text-xs text-white/50">© 2026 English Nerd. All rights reserved.</span>

          {/* Social icons */}
          <div className="flex items-center gap-3">
            {/* Pinterest */}
            <a href="https://pin.it/1QIuVSaoc" target="_blank" rel="noopener noreferrer" aria-label="Pinterest"
              className="flex h-8 w-8 items-center justify-center rounded-lg text-white/50 hover:text-white transition hover:bg-white/8">
