...
export const metadata = {
  alternates: { canonical: "/tenses/future-perfect" },
  title: { absolute: "Future Perfect Exercises — Practice English Grammar | English Nerd" },
  description:
    ...
    <main className="relative min-h-screen bg-[#0E0F13] text-white">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 py-12">
        ...
        <div className="mt-14 flex flex-col gap-14">
          ...
          <RelatedTopics exercises={RELATED} basePath="/tenses/future-perfect" />
        </div>
      </div>
    </main>
  );
