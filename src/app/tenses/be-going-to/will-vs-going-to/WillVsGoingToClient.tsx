    ...
    <div className="min-h-screen bg-white text-slate-900">
      <div className="mx-auto max-w-7xl px-6 py-10">
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-[300px_1fr_300px]">
          {isPro ? (
            <div className=""><SpeedRound gameId="bgt-will-vs-going-to" subject="Will vs Be Going To" questions={BGT_SPEED_QUESTIONS} variant="sidebar" /></div>
          ) : (
        ...
        {!isPro && (
          <div className="mt-10 grid gap-8 lg:grid-cols-[300px_1fr_300px]">
            ...
            <SpeedRound gameId="bgt-will-vs-going-to" subject="Will vs Be Going To" questions={BGT_SPEED_QUESTIONS} />
            <div className="hidden lg:block" />
          </div>
        )}
