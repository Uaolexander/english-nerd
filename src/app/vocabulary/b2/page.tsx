...
export const metadata: Metadata = {
  title: "B2 Vocabulary Exercises — English Nerd",
  description:
    "B2 Upper-Intermediate vocabulary exercises. Practise sophisticated collocations and topic-specific lexis through dialogues and activities.",
  alternates: { canonical: "/vocabulary/b2" },
};
...
const EXERCISES: Exercise[] = [
  {
    ...
    description:
      "A team discusses a new project strategy. Read the dialogue and choose the correct word for each gap.",
    questions: 10,
    tag: "Dialogue",
    image: "/topics/vocabulary/b2/business-meeting.jpg",
    isNew: true,
  },
  {
    slug: "environment",
    ...
    description:
      "Learn environmental vocabulary with three activities: multiple choice, choose the word, and fill in the blanks.",
    questions: 10,
    tag: "3 Exercises",
    image: "/topics/vocabulary/b2/environment.jpg",
    isNew: true,
  },
  {
    ...
    description:
      "Anna and her editor discuss trends in digital media. Read the dialogue and choose the correct word for each gap.",
    questions: 10,
    tag: "Dialogue",
    image: "/topics/vocabulary/b2/media-and-technology.jpg",
    isNew: true,
  },
  {
    slug: "social-issues",
    title: "Social Issues",
    description:
      "Learn social issues vocabulary with three activities: multiple choice, choose the word, and fill in the blanks.",
    questions: 10,
    tag: "3 Exercises",
    image: "/topics/vocabulary/b2/social-issues.jpg",
    isNew: true,
  },
];

export default async function VocabularyB2Page() {
      ...
      <div className="relative z-10">
        <div className="mx-auto max-w-6xl px-6 py-10">
          ...
          <h1 className="mt-4 text-3xl md:text-5xl font-black tracking-tight">
            B2 Vocabulary <span className="text-[#F5DA20]">Exercises</span>
          </h1>
          <p className="mt-3 max-w-2xl text-white/55 text-base leading-relaxed">
            Upper-Intermediate level — practise sophisticated vocabulary through dialogues and activities. Focus on collocations, register and topic-specific lexis.
          </p>
                ...
                <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-2">
                  {EXERCISES.map((ex) => (
                    ...
                    >
                      ...
                      {/* Full card link */}
                      {!ex.comingSoon && (
                        <a href={`/vocabulary/b2/${ex.slug}`} className="absolute inset-0" aria-label={ex.title} />
                      )}
                    </article>
                  ))}
                </div>
