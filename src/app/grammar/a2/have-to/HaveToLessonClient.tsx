...
const RECOMMENDATIONS: GrammarRec[] = [
  { title: "Should / Shouldn't", href: "/grammar/a2/should-shouldnt", level: "A2", badge: "bg-emerald-600", reason: "Another modal verb for advice and obligation" },
  { title: "Verb + Infinitive", href: "/grammar/a2/verb-infinitive", level: "A2", badge: "bg-emerald-600", reason: "Have to + infinitive — practise this pattern more" },
    ...
    <div className="mx-auto max-w-7xl px-6 py-10">
      ...
      {!isPro && (
        <div className="mt-10 grid gap-8 lg:grid-cols-[300px_1fr_300px]">
          ...
          <SpeedRound gameId="grammar-a2-have-to" subject="Have to" questions={SPEED_QUESTIONS} />
          <div className="hidden lg:block" />
        </div>
      )}
