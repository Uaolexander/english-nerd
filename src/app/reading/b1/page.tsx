...
export const metadata: Metadata = {
  title: "B1 Reading Practice | English Nerd",
  description:
    "B1 intermediate English reading exercises. News articles, blog posts and travel texts with comprehension, true/false and fill-in-the-blanks tasks. Free practice.",
  alternates: { canonical: "/reading/b1" },
};
...
const EXERCISES: Exercise[] = [
  {
    ...
    title: "Digital Lives",
    description:
      "Read what four young people say about their relationship with social media and technology. Are the statements true or false?",
    questions: 8,
    tag: "True / False",
    image: "/topics/reading/b1/digital-lives.jpg",
    isNew: true,
  },
  {
    ...
    description:
      "Read the article about slow travel and answer the comprehension questions.",
    questions: 6,
    tag: "Comprehension",
    image: "/topics/reading/b1/the-slow-travel-movement.jpg",
    isNew: true,
  },
  {
    slug: "work-from-home",
    ...
    description:
      "Read the blog post about remote work and fill in the missing words.",
    questions: 8,
    tag: "Fill in Blanks",
    image: "/topics/reading/b1/work-from-home.jpg",
    isNew: true,
  },
];

export default function ReadingB1Page() {
  return (
      ...
      <div className="relative z-10">
        <div className="mx-auto max-w-6xl px-6 py-10">
          ...
          <h1 className="mt-4 text-3xl md:text-5xl font-black tracking-tight">
            B1 Reading <span className="text-[#F5DA20]">Exercises</span>
          </h1>
          <p className="mt-3 max-w-2xl text-white/55 text-base leading-relaxed">
            Intermediate level -- news articles, blog posts and travel texts with
            comprehension tasks to build your reading fluency.
          </p>
                ...
                {EXERCISES.map((ex) => (
                  ...
                  >
                    ...
                    <div className="relative aspect-[4/3] w-full overflow-hidden border-b border-white/10 bg-black/30">
                      ...
                      {/* B1 badge */}
                      <div className="absolute top-3 left-3 rounded-full bg-violet-400 px-3 py-1 text-xs font-black text-black shadow-lg">
                        B1
                      </div>
