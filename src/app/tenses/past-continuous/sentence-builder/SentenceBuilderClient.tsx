                      ...
                      {!isChecked ? (
                        ...
                        <>
                          ...
                          {qIdx < current.questions.length - 1 && (
                            <button onClick={() => { const nq = qIdx + 1; setQIdx(nq); broadcastSB({ qIdx: nq }); window.scrollTo({ top: 0, behavior: "smooth" }); }} className="rounded-2xl bg-[#F5DA20] px-6 py-3 text-sm font-black text-black hover:opacity-90 transition shadow-sm">
                              Next →
                            </button>
                          )}
