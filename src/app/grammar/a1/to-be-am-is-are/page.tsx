...
export default function Page() {
  return (
    <>
      <LessonSchema
        title="Verb to Be (Am, Is, Are) Exercises for Beginners with Answers (A1)"
        description="Learn to use am, is and are in English. A1 grammar lesson with 4 exercises: affirmative, negative, questions and short answers. Free interactive practice."
        url="https://englishnerd.cc/grammar/a1/to-be-am-is-are"
        level="A1"
      />
