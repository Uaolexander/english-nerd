...
export const metadata = {
  alternates: { canonical: "/tenses/past-perfect-continuous" },
  title: { absolute: "Past Perfect Continuous Exercises — Practice English Grammar | English Nerd" },
  description:
    "Practise the Past Perfect Continuous tense with multiple choice, fill-in-the-blank, spot-the-mistake, and sentence-builder exercises. Learn had been + -ing, duration in the past with for and since, and the difference between Past Perfect and Past Perfect Continuous.",
  keywords: [
    "past perfect continuous exercises",
    "past perfect continuous practice",
    "had been ing exercises",
    "duration past perfect continuous",
...
const EXERCISES: Exercise[] = [
  {
    ...
    label: "Quiz",
    description: "Choose the correct Past Perfect Continuous form from four options.",
    difficulty: "Medium",
  ...
  },
  {
    ...
    label: "Writing",
    description: "Type the correct had been + -ing form to complete the sentence.",
    difficulty: "Medium",
    difficultyColor: "bg-[#F5DA20]",
  },
  {
    ...
    label: "Sharp eye",
    description: "Find the error: missing 'been', wrong auxiliary, or wrong verb form.",
    difficulty: "Hard",
    difficultyColor: "bg-rose-400",
  },
  {
    slug: "sentence-builder",
    imageSlug: "sentence-builder-past-perfect-continuous",
    title: "Sentence Builder",
    label: "Order",
    description: "Rearrange the words to build a correct Past Perfect Continuous sentence.",
    difficulty: "Hard",
    difficultyColor: "bg-rose-400",
  },
];
...
const RELATED: Exercise[] = [
  {
    ...
    title: "had been + -ing",
    label: "Structure",
    description: "Form the tense step by step: had + been + verb-ing.",
    difficulty: "Medium",
    difficultyColor: "bg-[#F5DA20]",
  },
  {
    slug: "for-since-past",
    title: "for vs since in the Past",
    label: "Duration",
    description: "She had been waiting for 3 hours / since morning. Duration before a past moment.",
    difficulty: "Medium",
    difficultyColor: "bg-[#F5DA20]",
  },
  {
    slug: "pp-vs-ppc-past",
    title: "Past Perfect vs Continuous",
    label: "Comparison",
    description: "He had read the book vs he had been reading. Result vs ongoing duration.",
    difficulty: "Hard",
    difficultyColor: "bg-rose-400",
  },
  {
    slug: "all-past-tenses",
  ...
  return (
    <main className="relative min-h-screen bg-[#0E0F13] text-white">
      <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-32 left-1/2 h-[500px] w-[700px] -translate-x-1/2 rounded-full bg-orange-500/6 blur-[150px]" />
        <div className="absolute top-1/3 -left-32 h-[400px] w-[400px] rounded-full bg-orange-400/5 blur-[120px]" />
        <div className="absolute top-1/3 -right-32 h-[400px] w-[400px] rounded-full bg-violet-400/4 blur-[120px]" />
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 py-12">
        <div className="text-sm text-white/40">
          ...
          <span className="mx-2 text-white/35">/</span>
          <span className="text-white/70">Past Perfect Continuous</span>
        </div>
        ...
        <div className="mt-6">
          ...
          <h1 className="mt-3 text-4xl font-black tracking-tight md:text-5xl">
            ...
            <span className="relative inline-block">
              <span className="relative z-10 text-orange-400">Continuous</span>
          ...
          <p className="mt-4 max-w-xl text-white/45 text-base leading-relaxed">
            The duration of an action before a specific moment in the past. Choose an exercise and start practising.
          </p>
        </div>

        <div className="mt-6 flex flex-wrap gap-2">
          {[
            { label: "+", example: "She had been working for 3 hours." },
            { label: "−", example: "He hadn't been sleeping well." },
            { label: "?", example: "Had they been waiting long?" },
          ].map(({ label, example }) => (
        ...
        <div className="mt-14 flex flex-col gap-14">
          <CardGroup label="Exercises" sublabel="Practice Past Perfect Continuous with different task types" dotColor="bg-orange-400" exercises={EXERCISES} basePath="/tenses/past-perfect-continuous" />
          <AdUnit variant="inline-light" />
          <RelatedTopics exercises={RELATED} basePath="/tenses/past-perfect-continuous" />
        </div>
      </div>
    </main>
  );
