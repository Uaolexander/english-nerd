...
const RECOMMENDATIONS: GrammarRec[] = [
  { title: "Have to / Don't have to", href: "/grammar/a2/have-to", level: "A2", badge: "bg-emerald-600", reason: "Compare 'should' with 'have to' for obligation" },
  { title: "Will (Future)", href: "/grammar/a2/will-future", level: "A2", badge: "bg-emerald-600", reason: "Both 'will' and 'should' are modal verbs" },
    ...
    <div className="mx-auto max-w-7xl px-6 py-10">
      ...
      {!isPro && (
        <div className="mt-10 grid gap-8 lg:grid-cols-[300px_1fr_300px]">
          ...
          <SpeedRound gameId="grammar-a2-should-shouldnt" subject="Should / Shouldn't" questions={SPEED_QUESTIONS} />
          <div className="hidden lg:block" />
        </div>
      )}
