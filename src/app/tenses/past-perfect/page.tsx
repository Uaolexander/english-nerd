...
export const metadata = {
  title: "Past Perfect Exercises — Practice English Grammar | English Nerd",
  description:
    "Practise the Past Perfect tense with multiple choice, fill-in-the-blank, spot-the-mistake, and sentence-builder exercises. Learn had + past participle, sequence of events, before/after/when, and the difference between Past Perfect and Past Simple.",
  keywords: [
    "past perfect exercises",
    "past perfect practice",
    "had past participle exercises",
    "before after when past perfect",
...
const EXERCISES: Exercise[] = [
  {
    ...
    label: "Quiz",
    description: "Choose the correct Past Perfect form from four options.",
    difficulty: "Easy",
  ...
  },
  {
    ...
    label: "Writing",
    description: "Type the correct had + past participle form to complete the sentence.",
    difficulty: "Medium",
  ...
  },
  {
    ...
    label: "Sharp eye",
    description: "Find the error: missing 'had', wrong participle, or wrong tense entirely.",
    difficulty: "Hard",
    difficultyColor: "bg-rose-400",
  },
  {
    slug: "sentence-builder",
    imageSlug: "sentence-builder-past-perfect",
    title: "Sentence Builder",
    label: "Order",
    description: "Rearrange the words to build a correct Past Perfect sentence.",
    difficulty: "Hard",
    difficultyColor: "bg-rose-400",
  },
];
...
const RELATED: Exercise[] = [
  {
    slug: "had-past-participle",
    title: "had / hadn't / Had I?",
    label: "Auxiliary",
    description: "Master the auxiliary verb 'had' — positives, negatives, and questions.",
    difficulty: "Easy",
    difficultyColor: "bg-emerald-400",
  },
  {
    slug: "sequence-of-events",
    title: "Sequence of Events",
    label: "Order",
    description: "Before she arrived, he had already left. Expressing which action came first.",
    difficulty: "Medium",
    difficultyColor: "bg-[#F5DA20]",
  },
  {
    ...
    label: "Comparison",
    description: "When must you use Past Perfect, and when is Past Simple enough?",
    difficulty: "Hard",
    difficultyColor: "bg-rose-400",
  },
  {
    ...
    label: "Vocabulary",
    description: "gone, seen, written, known — review the most essential irregular forms.",
    difficulty: "Medium",
    difficultyColor: "bg-[#F5DA20]",
  },
];
  ...
  return (
    <main className="relative min-h-screen bg-[#0E0F13] text-white">
      <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-32 left-1/2 h-[500px] w-[700px] -translate-x-1/2 rounded-full bg-violet-500/6 blur-[150px]" />
        <div className="absolute top-1/3 -left-32 h-[400px] w-[400px] rounded-full bg-violet-400/5 blur-[120px]" />
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 py-12">
        <div className="text-sm text-white/40">
          ...
          <span className="mx-2 text-white/20">/</span>
          <span className="text-white/70">Past Perfect</span>
        </div>

        <div className="mt-6">
          <div className="flex items-center gap-3">
            <span className="rounded-full bg-violet-400 px-3 py-0.5 text-[11px] font-black text-black">B1–B2</span>
            <span className="text-xs font-bold uppercase tracking-widest text-white/25">Past</span>
          </div>
          <h1 className="mt-3 text-4xl font-black tracking-tight md:text-6xl">
            Past{" "}
            <span className="relative inline-block">
              <span className="relative z-10 text-violet-400">Perfect</span>
              <span aria-hidden className="pointer-events-none absolute -bottom-1 left-0 h-1 w-full rounded-full bg-violet-400/30" />
            </span>
          </h1>
          <p className="mt-4 max-w-xl text-white/45 text-base leading-relaxed">
            An action completed before another past action. Choose an exercise and start practising.
          </p>
        </div>

        <div className="mt-6 flex flex-wrap gap-2">
          {[
            { label: "+", example: "She had left before he arrived." },
            { label: "−", example: "He hadn't seen it before." },
            { label: "?", example: "Had they finished?" },
          ].map(({ label, example }) => (
        ...
        <div className="mt-14 flex flex-col gap-14">
          ...
          <CardGroup label="Related Topics" sublabel="had + participle, sequence of events, and comparison with Past Simple" dotColor="bg-[#F5DA20]" exercises={RELATED} basePath="/tenses/past-perfect" />
        </div>
      </div>
    </main>
  );
