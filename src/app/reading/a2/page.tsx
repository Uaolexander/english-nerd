...
export const metadata: Metadata = {
  title: "A2 Reading Practice — English Nerd",
  description:
    "A2 elementary English reading exercises. Emails, short articles and stories with True/False, comprehension and fill-in-the-blanks tasks. Free practice.",
  alternates: { canonical: "/reading/a2" },
};
...
const EXERCISES: Exercise[] = [
  {
    ...
    title: "Pen Pals",
    description:
      "Read messages from four pen pals around the world and decide if the statements are true or false.",
    questions: 8,
    tag: "True / False",
    image: "/topics/reading/a2/pen-pals.jpg",
    isNew: true,
  },
  {
    slug: "a-weekend-trip",
    ...
    description:
      "Read about Sofia's weekend trip to the mountains and answer the comprehension questions.",
    questions: 6,
    tag: "Comprehension",
    image: "/topics/reading/a2/a-weekend-trip.jpg",
    isNew: true,
  },
  {
    ...
    description:
      "Read the article about city and country life and fill in the missing words.",
    questions: 8,
    tag: "Fill in Blanks",
    image: "/topics/reading/a2/city-or-country.jpg",
    isNew: true,
  },
];

export default function ReadingA2Page() {
  return (
      ...
      <div className="relative z-10">
        <div className="mx-auto max-w-6xl px-6 py-10">
          ...
          <h1 className="mt-4 text-3xl md:text-5xl font-black tracking-tight">
            A2 Reading <span className="text-[#F5DA20]">Exercises</span>
          </h1>
          <p className="mt-3 max-w-2xl text-white/55 text-base leading-relaxed">
            Elementary level: emails, postcards, short articles and stories with
            comprehension tasks to build your reading skills.
          </p>
                ...
                {EXERCISES.map((ex) => (
                  ...
                  >
                    ...
                    <div className="relative aspect-[4/3] w-full overflow-hidden border-b border-white/10 bg-black/30">
                      ...
                      {/* A2 badge */}
                      <div className="absolute top-3 left-3 rounded-full bg-emerald-400 px-3 py-1 text-xs font-black text-black shadow-lg">
                        A2
                      </div>
