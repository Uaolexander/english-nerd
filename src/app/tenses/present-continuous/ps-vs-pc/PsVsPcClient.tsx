      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
          ...
          {isPro ? (
            <aside className="flex flex-col gap-3">
              ...
              {[
                ...
                { title: "Advanced Mix", href: "/tenses/present-continuous/ps-pc-advanced", img: "/topics/exercises/ps-pc-advanced.jpg", level: "B1", badge: "bg-amber-500", reason: "Advanced challenge" },
              ].map((rec) => (
        ...
        {!isPro && (
          <div className="mt-10 grid gap-8 lg:grid-cols-[300px_1fr_300px]">
            ...
            <SpeedRound gameId="pc-ps-vs-pc" subject="Present Continuous" questions={PC_SPEED_QUESTIONS} />
            <div className="hidden lg:block" />
          </div>
        )}
