...
const PDF_CONFIG: LessonPDFConfig = {
  ...
  exercises: [
    ...
    },
    {
      ...
      title: "Exercise 3",
      difficulty: "Medium",
      instruction: "Circle the correct meaning (a or b).",
      questions: [
        "wake up → (a) stop sleeping  (b) start sleeping",
        "turn off → (a) start a device  (b) stop a device",
        "put on → (a) remove clothing  (b) dress yourself in",
        "look for → (a) wear something  (b) try to find",
        "come in → (a) leave a place  (b) enter a place",
        "pick up → (a) drop something  (b) lift something",
        "go out → (a) stay at home  (b) leave and socialise",
        "sit down → (a) stand up  (b) take a seat",
        "take off → (a) remove clothing  (b) put on clothing",
        "get up → (a) go to sleep  (b) rise from bed",
      ],
    },
    {
      number: 4,
  ...
  answerKey: [
    ...
    { exercise: 3, subtitle: "Medium — correct meaning", answers: ["(a)","(b)","(b)","(b)","(b)","(b)","(b)","(b)","(a)","(b)"] },
