...
export default async function GrammarC1Page() {
                    ...
                    <div className="p-5">
                      ...
                      <div className="mt-4 flex items-center justify-between">
                        <a
                          ...
                          aria-label={t.title}
                        />
                        <a href={`/grammar/c1/${t.slug}`} className="relative z-20 inline-flex items-center justify-center rounded-xl bg-[#F5DA20] px-4 py-2 text-sm font-bold text-black hover:opacity-90">
                          Start
                        </a>
