...
/**
 * StudentTour — spotlight product tour for students linked to a teacher.
...
const STEPS: TourStep[] = [
  {
    ...
    desc: "You've been connected to a teacher. Let us quickly show you what's available in your account.",
  },
  {
    id: "student-tab",
    target: "student-tab-btn",
    title: "Your Student Tab",
    desc: "This is where you find all assignments from your teacher — with deadlines, progress, and direct links to each task.",
    tip: "Your teacher can assign grammar, vocabulary, essays, and more.",
    tooltipSide: "bottom",
  ...
  },
  {
    ...
    desc: "Your Dashboard shows streaks, completed exercises, scores, and learning insights. Check it regularly to see how you're improving.",
    tip: "The streak counter resets if you skip a day — keep the chain going!",
    tooltipSide: "bottom",
    clickOnActivate: true,
    padding: 6,
  },
  {
    ...
    desc: "Check your Student tab for assignments, and use the Dashboard to track your growth. Good luck with your studies!",
...
export default function StudentTour({ userEmail, hasAssignments, onDone }: Props) {
  ...
  function finish() {
    localStorage.setItem(`student_tour_done_${userEmail}`, "1");
    onDone();
  }
            ...
            <div className="p-4 sm:p-5">
              <div className="mb-3 flex items-start justify-between gap-3">
                <div className="min-w-0">
                  <div className="mb-1 inline-flex items-center gap-1.5 rounded-full border px-2.5 py-0.5 text-[10px] font-black bg-emerald-500/15 border-emerald-500/30 text-emerald-400">
              ...
              <div className="mt-3 flex items-center justify-between sm:mt-4">
                ...
                <div className="flex items-center gap-2">
                  {idx > 0 && (
                    <button onClick={() => setIdx((i) => i - 1)} className="flex items-center gap-1 rounded-lg px-2.5 py-2 text-xs font-semibold text-white/50 transition hover:text-white/60 sm:px-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 rounded-xl px-4 py-2.5 text-xs font-black text-white transition hover:opacity-90 sm:py-2"
