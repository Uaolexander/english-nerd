  ...
  async function downloadPDF() {
    ...
    try {
      const config: ReadingPDFConfig = {
        ...
        level: "A2",
        filename: "EnglishNerd_A-Weekend-Trip_A2.pdf",
        passages: [{ text: TEXT }],
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-10">
      ...
      <div className="flex items-center gap-2 text-sm text-slate-500">
        ...
        <span className="text-slate-300">/</span>
        <span className="text-slate-700 font-medium">A Weekend Trip</span>
      </div>
      ...
      <p className="mt-3 max-w-3xl text-slate-700">
        Read the story and choose the best answer for each question.
      </p>
      ...
      <div className={`mt-10 grid gap-6 ${isPro ? "lg:grid-cols-[1fr_300px]" : "lg:grid-cols-[260px_1fr_260px]"}`}>
        ...
        {isPro ? (
          <ReadingRecommendations level="a2" currentSlug="a-weekend-trip" />
        ) : (
